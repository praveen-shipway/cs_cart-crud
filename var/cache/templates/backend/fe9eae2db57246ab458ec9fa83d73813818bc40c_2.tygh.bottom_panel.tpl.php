...
/* Smarty version 4.1.0, created on 2022-10-31 08:34:00
  from '/var/www/html/cs_cart-crud/design/backend/templates/components/bottom_panel/bottom_panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_635f5e48723fa8_68468636',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fe9eae2db57246ab458ec9fa83d73813818bc40c' => 
    array (
      0 => '/var/www/html/cs_cart-crud/design/backend/templates/components/bottom_panel/bottom_panel.tpl',
      1 => 1665485476,
      2 => 'tygh',
    ),
  ),
...
function content_635f5e48723fa8_68468636 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/cs_cart-crud/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),1=>array('file'=>'/var/www/html/cs_cart-crud/app/functions/smarty_plugins/modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'/var/www/html/cs_cart-crud/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),3=>array('file'=>'/var/www/html/cs_cart-crud/app/functions/smarty_plugins/function.script.php','function'=>'smarty_function_script',),));
...
$_smarty_tpl->_assignInScope('c_url', fn_url($_smarty_tpl->tpl_vars['config']->value['current_url']));?>
...
echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable5,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
            ...
            <?php if (defined("THEMES_PANEL") || $_smarty_tpl->tpl_vars['auth']->value['user_type'] === smarty_modifier_enum("UserTypes::ADMIN")) {?>
                <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.login_as_admin?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id']),"C"), ENT_QUOTES, 'UTF-8');?>
...
" class="bp-nav__item cm-no-ajax cm-post
        ...
        <?php if ((defined('ACCOUNT_TYPE') ? constant('ACCOUNT_TYPE') : null) === "customer" && (!fn_allowed_for("MULTIVENDOR:ULTIMATE") || empty($_smarty_tpl->tpl_vars['auth']->value['storefront_id']) || (int) $_smarty_tpl->tpl_vars['auth']->value['storefront_id'] === (int) $_smarty_tpl->tpl_vars['runtime']->value['storefront_id'])) {?>
            <div class="bp-modes">
                <a
...
echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable6), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable7=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable7), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable8=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable8), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } else { ?>
...
echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable9), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable10), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable11), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
